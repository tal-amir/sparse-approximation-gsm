function h = plotTwoMethodComparison(h, titleStr, objx, labelx, objy, labely, colorVals, colorStr, sizeVals, varargin)
%function h = plotTwoMethodComparison(titleStr, objx, labelx, objy, labely, colorVals, colorStr, sizeVals, varargin)
...
scatter(objx, objy, sizeVals, colorVals, params.markerStyle);
...
cb = colorbar;
cb.Label.String = colorStr;
cb.Label.Interpreter = 'latex';
cb.Label.FontSize = params.colorbarFontSize;
